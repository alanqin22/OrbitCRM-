"""Unified CRM Agent application — all 10 modules + home index dashboard.
...
async def lifespan(app: FastAPI):
    logger.info("=== CRM Agent starting up (all 10 modules + home index) ===")
...
app = FastAPI(
    title="CRM Agent",
    description=(
        "Unified CRM AI Agent -- all 10 modules on a single FastAPI server: "
        "accounts, contacts, products, orders, activities, opportunities, "
        "accounting, leads, analytics, notifications. "
...
@app.get("/health")
async def health():
    """Aggregate health check — home index + all 10 agents."""
